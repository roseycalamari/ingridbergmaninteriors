...
const translations = {
    en: {
        ...
        conceptDesignDesc: "We offer bespoke interior design concepts and solutions tailored to your space. From initial vision to final detail, we transform interiors into beautiful, functional environments that reflect your style.",
        spacePlanning: "Space Planning",
        spacePlanningDesc: "We create smart space and floor plans to help you get the most out of your home. Our designs optimize flow, function, and comfort—so every square meter works beautifully for you.",
        furnitureSourcing: "Furniture Sourcing",
        furnitureSourcingDesc: "We source high-quality furniture for both indoor and outdoor spaces. With our large collection of styles and finishes, we help you find pieces that perfectly suit your home and lifestyle.",
        windowTreatment: "Window Treatment",
        windowTreatmentDesc: "We offer tailored window treatment solutions that combine style, privacy, and light control. From elegant curtains to modern blinds, we help you choose the best option for your home.",
        lightingPlanning: "Lighting",
        lightingPlanningDesc: "We design custom lighting concepts that enhance the mood, function, and beauty of your home. From subtle ambiance to striking focal points, we create lighting that brings your space to life.",
        accessoriesCarpets: "Accessories & Carpets",
        accessoriesCarpetsDesc: "Accessories and carpets are the finishing touch that complete your space. We offer a curated selection to add warmth, character, and style—creating a home that feels truly yours.",
